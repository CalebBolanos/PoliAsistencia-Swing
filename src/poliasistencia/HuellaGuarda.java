...
public class HuellaGuarda extends javax.swing.JDialog {
...
private javax.swing.JButton btnGuardar;
    ...
    public HuellaGuarda(String metetodoloquevasasubiralabase) {
        initComponents();
    }
 ...
 if (featuresinscripcion != null)
	...
	switch(Reclutador.getTemplateStatus())
	    ...
	    Reclutador.clear();
            stop();
	    setTemplate(null);
	    JOptionPane.showMessageDialog(HuellaGuarda.this, "La Plantilla de la Huella no pudo ser creada, Repita el Proceso", "Inscripcion de Huellas Dactilares", JOptionPane.ERROR_MESSAGE);
	    start();
	    break;
	}
	     }
...
public  void stop(){
    ...
    public void guardarHuella(){
     ...
     reg.registroHuella(datosHuella, tamañoHuella);
     stop();
//     try {
//         
//         //Aqui pondiras la sentencia para guardar todo
