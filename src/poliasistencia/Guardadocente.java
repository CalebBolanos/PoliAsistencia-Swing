...
public class Guardadocente extends javax.swing.JDialog {
    ...
    public Guardadocente() {
        initComponents();
    }

    //Este constructor recibe todo para guardar y lo mandas en el metodo guardar huella que esta mas abajo
    public Guardadocente(int tip, int gen, String nom, String pat, String mat, String fech, String bol) {
        //
        GEN = gen;
        NOM = nom;
        PAT = pat;
            ...
            try {
                ...
                switch (Reclutador.getTemplateStatus()) {
                    ...
                    case TEMPLATE_STATUS_FAILED:
                        ...
                        stop();
                        setTemplate(null);
                        JOptionPane.showMessageDialog(Guardadocente.this, "La Plantilla de la Huella no pudo ser creada, Repita el Proceso", "Inscripcion de Huellas Dactilares", JOptionPane.ERROR_MESSAGE);
                        start();
                        break;
                }
            }
