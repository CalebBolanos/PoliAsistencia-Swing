...
public class Guardaalumno extends javax.swing.JDialog {
    ...
    public Guardaalumno(int gen, String nom, String pat, String mat, String fech, String bol) {
            ...
            try {
                ...
                switch (Reclutador.getTemplateStatus()) {
                    ...
                    case TEMPLATE_STATUS_FAILED:
                        ...
                        stop();
                        setTemplate(null);
                        JOptionPane.showMessageDialog(Guardaalumno.this, "La Plantilla de la Huella no pudo ser creada, Repita el Proceso", "Inscripcion de Huellas Dactilares", JOptionPane.ERROR_MESSAGE);
                        start();
                        break;
                }
            }
